                ...
                {title ? (
                    <>
                        <div className="flex items-center col-span-6 gap-x-2.5 w-full">
                            ...
                            <h3 className="col-span-5 font-semibold text-base w-full">{title}</h3>
                        </div>
                        <div className="col-span-1"></div>
                        <p className="col-span-5 text-sm text-black w-full">{message}</p>
                    </>
                ) : (
                    <>
                        <div className="flex items-center col-span-6 gap-x-2.5 w-full">
                            <div className="col-span-1">{renderIcon()}</div>
                            <h3 className="col-span-5 font-semibold text-base w-full">{message}</h3>
                        </div>
                    </>
                )}
            </div>
