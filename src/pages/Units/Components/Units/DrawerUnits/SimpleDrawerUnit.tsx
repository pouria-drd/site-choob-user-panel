...
function SimpleDrawerUnit({ projectId, title }: { projectId: string; title: string }) {
    ...
    const calculate = async () => {
        ...
        try {
            ...
            var result = await unitProjectService.CalculateSimpleDrawerUnit<any>(dtoToSend);
...
export default SimpleDrawerUnit;
