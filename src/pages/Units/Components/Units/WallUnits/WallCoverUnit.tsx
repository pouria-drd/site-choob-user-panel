...
function WallCoverUnit({ projectId, title }: { projectId: string; title: string }) {
    ...
    const [dto, setDTO] = useState<WallCoverUnitDTO>(defaultDTO);
                    ...
                    <div className="flex flex-col sm:flex-row justify-around items-center gap-2 p-2">
                        ...
                        <div className="w-full flex items-center justify-center py-4 md:py-0">
                            <img
                                ...
                                src="https://cdn.sitechoob.ir/public/units/WallCoverUnit.png"
                            />
                        </div>
                    </div>
