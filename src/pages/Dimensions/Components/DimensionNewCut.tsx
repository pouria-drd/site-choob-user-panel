    ...
    const handleInputChange = (
        ...
        setFormData((prevData) => {
            ...
            if (
                ...
                (fieldName === "xGazor" || fieldName === "yGazor") &&
                value === true
            ) {
                return {
                    ...prevData,
    ...
    return (
        ...
        >
                            ...
                            <div className="flex flex-col justify-center gap-2">
                                ...
                                <div className="flex items-center justify-start w-full gap-2">
                                    <input
                                        ...
                                        onChange={(e) =>
                                            handleInputChange("pvctop", e.target.checked)
                                        }
                                    />
                                    <label className="cursor-pointer" htmlFor="pvcTop">
                                        بالا
                                    </label>
                                </div>
                                <div className="flex items-center justify-start w-full gap-2">
                                    <input
                                        ...
                                        onChange={(e) =>
                                            handleInputChange("pvcbottom", e.target.checked)
                                        }
                                    />
                                    <label className="cursor-pointer" htmlFor="pvcbottom">
                                        پایین
                                    </label>
                                </div>
                            </div>
                            ...
                            <div className="flex flex-col items-center gap-2">
                                ...
                                <div className="flex items-center justify-start w-full gap-2">
                                    <input
                                        ...
                                        onChange={(e) =>
                                            handleInputChange("pvcright", e.target.checked)
                                        }
                                    />
                                    <label className="cursor-pointer" htmlFor="pvcRight">
                                        راست
                                    </label>
                                </div>
                                <div className="flex items-center justify-start w-full gap-2">
                                    <input
                                        ...
                                        onChange={(e) =>
                                            handleInputChange("pvcleft", e.target.checked)
                                        }
                                    />
                                    <label className="cursor-pointer" htmlFor="pvcLeft">
                                        چپ
                                    </label>
                                </div>
                            </div>
                        ...
                        <div className="flex flex-col items-center justify-center gap-3 h-full">
                            <div className="flex items-center gap-2">
                                <input
                                    ...
                                    onChange={(e) =>
                                        handleInputChange("xGroove", e.target.checked)
                                    }
                                />
                                <label className="cursor-pointer" htmlFor="xGroove">
                                    شیار طول
                                </label>
                            </div>
                            ...
                            <div className="flex items-center gap-2">
                                <input
                                    ...
                                    onChange={(e) =>
                                        handleInputChange("yGroove", e.target.checked)
                                    }
                                />
                                <label className="cursor-pointer" htmlFor="yGroove">
                                    شیار عرض
                                </label>
                            </div>
                        </div>
                        ...
                        <div className="flex flex-col items-center justify-center gap-3 h-full">
                            <div className="flex items-center gap-2">
                                <input
                                    ...
                                    onChange={(e) =>
                                        handleInputChange("xGazor", e.target.checked)
                                    }
                                />
                                <label className="cursor-pointer" htmlFor="xGazor">
                                    گازور طول
                                </label>
                            </div>
                            ...
                            <div className="flex items-center gap-2">
                                <input
                                    ...
                                    onChange={(e) =>
                                        handleInputChange("yGazor", e.target.checked)
                                    }
                                />
                                <label className="cursor-pointer" htmlFor="yGazor">
                                    گازور عرض
                                </label>
                            </div>
                        </div>
            ...
            <div className="hidden md:block">
                <Button text="افزودن" onClick={addToTheList} isBusy={isProcessing} />
            </div>
