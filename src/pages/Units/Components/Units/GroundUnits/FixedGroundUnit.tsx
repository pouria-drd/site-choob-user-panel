...
function FixedGroundUnit({ projectId, title }: { projectId: string; title: string }) {
                    ...
                    <div className="flex flex-col sm:flex-row justify-around items-center gap-2 p-2">
                        <div className="flex flex-col gap-3 px-2  py-2  w-full md:w-1/2">
                            ...
                            <div className="flex flex-col w-full">
                                ...
                                {dto.hasHiddenHandle && (
                                    <div className="flex flex-col w-full">
                                        <label className="text-xs sm:text-sm md:text-base">بالای درب مخفی (سانتی متر)</label>
                                        <input
                                            className="base-input w-full"
                        ...
                        <div className="w-full flex items-center justify-center py-4 md:py-0">
                            <img
                                ...
                                src="https://cdn.sitechoob.ir/public/units/FixedGroundUnit.png"
                            />
                        </div>
                    </div>
