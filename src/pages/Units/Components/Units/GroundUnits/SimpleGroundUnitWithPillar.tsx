...
function SimpleGroundUnitWithPillar({ projectId }: { projectId: string }) {
    ...
    const [dto, setDTO] = useState<SimpleGroundUnitWithPillarDTO>({ depth: 0, width: 0, height: 0, pillarDepth: 20, pillarWidth: 40, shelfCount: 2, legColor: { colorName: 'رنگ 1' }, doors: [] });
