...
const Dropdown = ({
  ...
  return (
    <div className="flex flex-col font-peyda text-sc-blue-normal w-full gap-2 ss02">
      ...
      >
        <span className="text-sc-gray-normal text-right py-1 px-4">
          {title}
        </span>
      ...
      <div
        ...
        className={`bg-sc-purple-normal flex flex-col divide-y divide-dashed divide-gray-400 text-sm rounded overflow-hidden transition-all outline-none hover:outline hover:outline-sc-blue-normal px-2 gap-1 ${
          isOpen ? "py-2" : ""
        }`}
      >
        {options.map((option) => (
          <div
            ...
            className={`flex items-center last:mb-3 justify-end hover:bg-gray-50 rounded-lg cursor-pointer gap-4 p-2 ${
