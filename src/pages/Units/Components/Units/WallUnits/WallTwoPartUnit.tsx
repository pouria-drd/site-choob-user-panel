                    ...
                    <div className="flex flex-col sm:flex-row justify-around items-center gap-2 p-2">
                        <div className="flex flex-col gap-3  px-2  py-2  w-full md:w-1/2">
                            ...
                            <NumberInput
                                label="ارتفاع پایین"
                                type="cm"
                                value={dto.bottomHeight}
                                onValueChange={(v) => handleInputChange('bottomHeight', v)}
                            />
                            <div className="flex flex-col gap-2 w-full">
                                ...
                                {dto.bottomHasHiddenHandle && (
                                    <NumberInput
                                        ...
                                        type="cm"
                                        value={dto.bottmDoorExteraHeight}
                                        onValueChange={(v) => handleInputChange('bottmDoorExteraHeight', v)}
                                    />
                                )}
                            </div>
                            ...
                            <div className="flex flex-col gap-2 w-full">
                                ...
                                {dto.topHasHiddenHandle && (
                                    <NumberInput
                                        ...
                                        type="cm"
                                        value={dto.topDoorExteraHeight}
                                        onValueChange={(v) => handleInputChange('topDoorExteraHeight', v)}
                                    />
                                )}
                            </div>
                            ...
                            <NumberInput
                                label="عمق پایین"
                                type="cm"
                                value={dto.bottomDepth}
                                onValueChange={(v) => handleInputChange('bottomDepth', v)}
                            />
                            <NumberInput
                                label="عمق بالا"
                                type="cm"
                        ...
                        <div className="w-full flex items-center justify-center py-4 md:py-0">
                            <img
                                ...
                                src="https://cdn.sitechoob.ir/public/units/WallTwoPartUnit.png"
                            />
                        </div>
                    </div>
