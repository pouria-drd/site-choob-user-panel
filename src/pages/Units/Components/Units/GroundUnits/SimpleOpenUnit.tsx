...
function SimpleOpenUnit({ projectId, title }: { projectId: string; title: string }) {
    ...
    const calculate = async () => {
        ...
        try {
            ...
            var result = await unitProjectService.CalculatedSimpleOpenUnit<any>(dtoToSend);
                    ...
                    <div className="flex flex-col sm:flex-row justify-around items-center gap-2 p-2">
                        ...
                        <div className="w-full flex items-center justify-center py-4 md:py-0">
                            <img
                                ...
                                src="https://cdn.sitechoob.ir/public/units/GroundOpenUnit.png"
                            />
                        </div>
                    </div>
