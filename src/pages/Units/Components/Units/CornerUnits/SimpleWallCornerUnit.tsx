...
function SimpleWallCornerUnit({ projectId, title }: { projectId: string; title: string }) {
    ...
    const defaulDTO: SimpleWallCornerDTO = {
        rightWidth: 0,
        leftWidth: 0,
        height: 0,
        rightDepth: 0,
    ...
    const [dto, setDTO] = useState<SimpleWallCornerDTO>(defaulDTO);
    ...
    const handleInputChange = (fieldName: keyof SimpleWallCornerDTO, value: number | SimpleColorDTO) => {
        setDTO((prevDTO) => {
...
export default SimpleWallCornerUnit;
