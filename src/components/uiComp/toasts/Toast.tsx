...
const Toast = ({ type, title, message, onClose = () => {}, duration = 4000 }: ToastProps) => {
                ...
                {title && (
                    <>
                        <div className="flex items-center col-span-6 gap-x-2.5 w-full">
                            ...
                            <h3 className="col-span-5 font-semibold text-sm sm:text-base w-full">{title}</h3>
                        </div>
                        <div className="col-span-1"></div>
                        <p className="col-span-5 text-black text-xs sm:text-sm w-full">{message}</p>
                    </>
                )}
                ...
                {!title && (
                    <>
                        <div className="flex items-center col-span-6 gap-x-2.5 w-full">
                            ...
                            <h3 className="col-span-5 font-semibold text-base sm:text-lg">{message}</h3>
                        </div>
                    </>
                )}
            </div>
