...
function SimpleGroundCornerUnit({ projectId, title }: { projectId: string; title: string }) {
    ...
    const defaulDTO: SimpleGroundCornerDTO = {
        rightWidth: 0,
        leftWidth: 0,
        height: 0,
        rightDepth: 0,
    ...
    const [dto, setDTO] = useState<SimpleGroundCornerDTO>(defaulDTO);
    ...
    const handleInputChange = (fieldName: keyof SimpleGroundCornerDTO, value: number | SimpleColorDTO) => {
        setDTO((prevDTO) => {
...
export default SimpleGroundCornerUnit;
