...
function GroundCornerUnitWithPillar({ projectId, title }: { projectId: string; title: string }) {
    ...
    const defaulDTO: GroundCornerWithPillarDTO = {
        pillarWidth: 0,
        pillarDepth: 0,
        rightWidth: 0,
        leftWidth: 0,
    ...
    const [dto, setDTO] = useState<GroundCornerWithPillarDTO>(defaulDTO);
    ...
    const handleInputChange = (fieldName: keyof GroundCornerWithPillarDTO, value: number | SimpleColorDTO) => {
        setDTO((prevDTO) => {
    ...
    const calculate = async () => {
        ...
        try {
            ...
            var result = await unitProjectService.CalculatedGroundCornerUnitWithPillar<any>(dtoToSend);
    ...
    const createDTO = async () => {
        ...
        let Props: UnitProjectDimensionsPropsModel[] = [
            ...
            { name: 'legColor', title: 'پاخور', value: dto.legColor.colorName },
        ];
...
export default GroundCornerUnitWithPillar;
