...
import TallUnitProjectService from '../../../../../services/units/TallUnitProjectService';
...
function SimpleTallUnit({ projectId, title }: { projectId: string; title: string }) {
    const { showToast } = useToast();

    const unitProjectService = new TallUnitProjectService();
    ...
    const [dto, setDTO] = useState<SimpleTallUnitDTO>(defaulDTO);
    ...
    const handleInputChange = (fieldName: keyof SimpleGroundUnitDTO, value: number | SimpleColorDTO) => {
        setDTO((prevDTO) => {
    ...
    const calculate = async () => {
        ...
        try {
            ...
            var result = await unitProjectService.CalculateSimpleTallUnit<any>(dtoToSend);
                    ...
                    <div className="flex flex-col sm:flex-row justify-around items-center gap-2 p-2">
                        ...
                        <div className="w-full flex items-center justify-center py-4 md:py-0">
                            <img
                                ...
                                src="https://cdn.sitechoob.ir/public/units/SimpleTallUnit.png"
                            />
                        </div>
                    </div>
